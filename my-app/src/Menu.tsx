  ...
  return (
    <>
        <div style={{position:'relative', width:'100vw', height:'100vh', backgroundColor: '#f8f4dc'}}>
          ...
          <span className="menu-entry" style = {{padding:'10px', ...(selected == 'HOME' ? selectedStyle : {})}} onClick={() => setSelected('HOME')}>HOME</span>
        ...
        <span className="menu-entry" style={{padding:'10px',...(selected == 'TEST' ? selectedStyle : {})}} onClick={() => setSelected('TEST')}> LINKS</span>
